// https://github.com/xiaody/react-touch-carousel/blob/6b3b178880459a3a00a151de43daca6b9c306112/lib/touchWithMouseHOC.js
...
function touchWithMouseHOC(Component) {
  ...
  var TouchWithMouse = (function (_React$Component) {
    ...
    function TouchWithMouse(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (
          TouchWithMouse.__proto__ || Object.getPrototypeOf(TouchWithMouse)
        ).call(this, props)
      );
      ...
      _this.mockTouchEvent = function (e) {
        ...
        return {
          changedTouches: overwrites.changedTouches || [
            { identifier: _this.mouseTouchId, pageX: e.pageX, pageY: e.pageY },
          ],
      ...
      _this.onDocumentClick = function (e) {
        if (
          _this.clickStartX !== null &&
          _this.clickStartY !== null &&
          distance(_this.clickStartX, _this.clickStartY, e.pageX, e.pageY) >
            clickTolerance
        ) {
          _this.clickStartX = null;
          _this.clickStartY = null;
  ...
  TouchWithMouse.displayName =
    "TouchWithMouse(" + (Component.displayName || Component.name) + ")";
